...
use App\services\UserServices\UserRegister\UserRegister;
use App\services\UserServices\UserRegister\UserRegisterServices as UserRegisterUserRegisterServices;
use App\services\UserServices\UserRegisterServices\UserRegisterServices;
use Exception;
...
class UserController extends Controller
{
    ...
    public function login(Request $request){
        ...
        // return (new UserLoginServices('user'))->login($request);
    }
    /**
     * Register a User.
     *
